...
#define MAX_PENDING_PATHS 8       // 8个路径
...
static void add_pending_update_path(const char *path) {
    ...
    printf("Added pending update path: %s (total paths: %d, total events: %d)\n", 
           update_path, operation_state.path_count, operation_state.total_events);
